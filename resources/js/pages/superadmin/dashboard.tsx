            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                {isSuperAdmin && (
                    <div className="flex gap-4">
                        <Link href="/users" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                            Manage Users
                        </Link>
                        <Link href="/stations" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                            Manage Stations
                        </Link>
                        <Link href="/documents/create" className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                            Create Document
                        </Link>
                    </div>
                )}
